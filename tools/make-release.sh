#!/bin/bash
# Builds dist/folder-watch-for-vlc-<version>.zip: the three scripts, installer, README, LICENSE, CHANGELOG.
set -euo pipefail
cd "$(dirname "$0")/.."
...
cp -R lua install.sh README.md LICENSE CHANGELOG.md "$OUT/"
